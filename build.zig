// modified from: https://github.com/tobiaskohlbau/zig-mbedtls
...
pub fn build(b: *std.Build) !void {
    ...
    lib.addIncludePath(b.path("mbedtls/include"));
    lib.addIncludePath(b.path("mbedtls/library"));
    ...
    lib.installHeadersDirectory(b.path("mbedtls/include"), ".", .{});
    lib.installHeadersDirectory(b.path("mbedtls/library"), ".", .{});
    ...
    selftest.addCSourceFile(.{ .file = b.path("mbedtls/programs/test/selftest.c"), .flags = &.{} });
...
// TODO: update mbedtls from f71e2878084126737cc39083e1e15afc459bd93d
const srcs = &.{
